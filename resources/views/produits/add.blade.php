...
<div class="card">
    ...
    <div class="card-body">
        <form class="forms-sample" method="POST" action="{{ route('produit.store') }}">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" name="prix" class="form-control" id="exampleInputEmail3" placeholder="prix" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
